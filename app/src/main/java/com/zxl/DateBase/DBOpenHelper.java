...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_NAME = "BookKeeping";
    public static final Integer DB_VERSION = 1;
    public static final String TB_TYPE = "typeTb";
    public static final String TB_ACCOUNT = "accountTb";
    ...
    public void onCreate(SQLiteDatabase db) {
        //创建类型表
        String sql = "CREATE TABLE " + TB_TYPE +
    ...
    private void insertType(SQLiteDatabase db) {
        //typeTb表插入元素
        String sql = "INSERT INTO "+DBOpenHelper.TB_TYPE+" (typeName,imageId,sImageId,kind) VALUES (?,?,?,?)";
